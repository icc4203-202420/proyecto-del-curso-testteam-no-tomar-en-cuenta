...
Para cada uno de los requisitos listados anteriormente, se debe presentar un diseño de interfaz móvil de mediana fidelidad, es decir, mostrar todas las pantallas asemejándose a la interfaz real, pero sin implementar funcionalidad real, sino sólo navegación básica mediante enlaces entre las distintas pantallas.
